...
const Testimonials = () => {
  ...
  useEffect(() => {
    fetch('https://bistro-boss-server-two-green.vercel.app/reviews')
    .then(res => res.json())
...
<Swiper navigation={true} modules={[Navigation]} className="mySwiper">
      ...
      readOnly
    />
    <svg className="my-10" xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 100 100" fill="none">
